---
name: tools
description: "Skill for the Tools area of async-hermes-agent. 2132 symbols across 202 files."
---

# Tools

2132 symbols | 202 files | Cohesion: 64%
...
| `tools/mcp_tool.py` | _refresh_tools, _register_server_tools, _discover_and_register_server, SamplingHandler, MCPServerTask (+55) |
...
| `tools/browser_tool.py` | _requires_real_termux_browser_install, _extract_screenshot_path_from_text, _run_browser_command, _truncate_snapshot, browser_snapshot (+35) |
...
| `FakeFileOps` | Class | `tests/tools/test_patch_parser.py` | 157 |
...
| Area | Connections |
|------|-------------|
| Hermes_cli | 154 calls |
| Gateway | 49 calls |
| Agent | 47 calls |
| Environments | 38 calls |
| Platforms | 36 calls |
| Run_agent | 21 calls |
| Skills | 19 calls |
| Tests | 17 calls |
